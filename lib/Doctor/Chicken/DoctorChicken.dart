...
import 'package:tania_farm/Doctor/Chicken/DoctorChickenTreatment.dart';
...
class _DoctorChickenState extends State<DoctorChicken> {
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5010/doctors/chicken/doctor?user_id=${user_id}');
