...
class _DoctorChickenTreatmentState extends State<DoctorChickenTreatment> {
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5010/doctors/chicken/chicken?user_id=${user_id}&phase_number=${widget.chicken_id}');
  ...
  void handleSubmit() async {
    ...
    String? user_id = prefs.getString('user_id');
    final url = Uri.parse('http://68.178.163.174:5010/doctors/chicken/treatment?doctor_id=${user_id}');
