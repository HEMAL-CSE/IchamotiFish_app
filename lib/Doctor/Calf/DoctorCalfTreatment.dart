...
class _DoctorCalfTreatmentState extends State<DoctorCalfTreatment> {
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5010/doctors/calf/calf?user_id=${user_id}&calf_id=${widget.calf_id}');
  ...
  void handleSubmit() async {
    ...
    String? user_id = prefs.getString('user_id');
    final url = Uri.parse('http://68.178.163.174:5010/doctors/calf/treatment?doctor_id=${user_id}');
