...
print(user_id);
    ...
    final url = Uri.parse('http://68.178.163.174:5010/doctors/breeding/cow?user_id=${user_id}&cow_id=${widget.cow_id}');
  ...
  void handleSubmit() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5010/doctors/breeding/treatment?doctor_id=${user_id}');
