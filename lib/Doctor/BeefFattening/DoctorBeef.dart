...
import 'package:tania_farm/Doctor/BeefFattening/DoctorBeefTreatment.dart';
...
class _DoctorBeefState extends State<DoctorBeef> {
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5010/doctors/beef/doctor?user_id=${user_id}');
