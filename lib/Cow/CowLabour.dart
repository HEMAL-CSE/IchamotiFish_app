...
class _BreedingLabourState extends State<BreedingLabour> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/breeding_labour');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/breeding_labour/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/breeding_labour/edit?id=${editid.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/breeding_labour/delete?id=${id}');
