...
import 'package:tania_farm/components/VideoPlay.dart';
...
class _BreedingTreatmentState extends State<BreedingTreatment> {
  ...
  void getDoctors() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/doctors');
    Response res = await get(url);
  ...
  void handleSubmit() async {
    ...
    for(var i in doctors){
      ...
      if(i['selected'] == true){
        MultipartRequest request = MultipartRequest('POST', Uri.parse('http://68.178.163.174:5010/breeding/treatment'));
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5010/doctors/breeding?farm_id=${farm_id}');
  ...
  void deleteData(cow_id, doctor_id) async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/treatment/delete?cow_id=${cow_id}&doctor_id=${doctor_id}');
