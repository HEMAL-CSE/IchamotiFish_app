...
class _BreedingFeedState extends State<BreedingFeed> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/breeding_feed');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/breeding_feed/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/breeding_feed/edit?id=${editid.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/breeding_feed/delete?id=${id}');
