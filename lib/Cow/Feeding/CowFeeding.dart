...
class _BreedingFeedingState extends State<BreedingFeeding> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/feed_names');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/feed_names/add');
  ...
  void editData() async{
    final url = Uri.parse('http://68.178.163.174:5010/breeding/feed_names/edit?id=${editId.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/breeding/feed_names/delete?id=${id}');
