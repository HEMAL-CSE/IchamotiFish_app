...
class _CalfOthersPaymentState extends State<CalfOthersPayment> {
  ...
  void getOthers(shed_id, seat_id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others?shed_id=${shed_id}&&seat_id=${seat_id}');
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others_payment');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others_payment/add');
    Map body = {
      'shed_id': shed_id,
      'seat_id': seat_id,
      'others_id': others_id,
  ...
  void editData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others_payment/edit?id=${id}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others_payment/delete?id=${id}');
