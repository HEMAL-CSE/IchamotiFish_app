...
class _CalfOthersState extends State<CalfOthers> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others/add');
    Map body = {
      'shed_id': shed_id,
      'seat_id': seat_id,
      'name': name.text,
  ...
  void editData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others/edit?id=${id}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/calf_others/delete?id=${id}');
