...
class _CalfBirthState extends State<CalfBirth> {
  ...
  void getCalf() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/add');
    Map body = {
      'shed_id': shed_id,
      'seat_id': seat_id,
  ...
  void editData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/edit?id=${id}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/delete?id=${id}');
