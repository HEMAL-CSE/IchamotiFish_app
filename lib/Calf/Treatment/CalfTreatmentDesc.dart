...
class _CalfTreatmentDescState extends State<CalfTreatmentDesc> {
  ...
  void getDoctors() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/doctors');
    Response res = await get(url);
  ...
  void handleSubmit() async {
    ...
    for(var i in doctors){
      ...
      if(i['selected'] == true){
        MultipartRequest request = MultipartRequest('POST', Uri.parse('http://68.178.163.174:5010/calf/treatment'));
  ...
  void getData() async {
    ...
    final url = Uri.parse('http://68.178.163.174:5010/doctors/calf?farm_id=${farm_id}');
  ...
  void deleteData(calf_id, doctor_id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/treatment/delete?calf_id=${calf_id}&doctor_id=${doctor_id}');
