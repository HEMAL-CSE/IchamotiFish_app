...
class _CalfTreatmentDoctorState extends State<CalfTreatmentDoctor> {
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/doctors/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/doctors/edit?id=${editid.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/calf/doctors/delete?id=${id}');
