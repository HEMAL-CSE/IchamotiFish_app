...
class _VermiCompostShedState extends State<VermiCompostShed> {
  ...
  void getData() async{
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/vermicompost_prod?shed_id=${widget.shed_id}');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/vermicompost_prod/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/vermicompost_prod/edit?id=${editid.text}');
  ...
  void deleteData(id) async{
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/vermicompost_prod/delete?id=${id}');
