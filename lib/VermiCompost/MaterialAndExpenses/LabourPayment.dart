...
class _LabourPaymentState extends State<LabourPayment> {
  ...
  void getLabours() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/labour_list');
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/labour_payment');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/labour_payment/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/labour_payment/edit?id=${editid.text}');
  ...
  void deleteData(id) async{
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/labour_payment/delete?id=${id}');
