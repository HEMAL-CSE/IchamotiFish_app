...
class _VermiCompostSellsState extends State<VermiCompostSells> {
  ...
  void getData() async{
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/vermicompost_sells');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/vermicompost_sells/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/vermicompost_sells/edit?id=${editid.text}');
  ...
  void deleteData(id) async{
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/vermicompost_sells/delete?id=${id}');
