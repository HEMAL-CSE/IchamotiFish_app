...
class _EarthwormLabourState extends State<EarthwormLabour> {
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/earthworm_labour/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/earthworm_labour/edit?id=${editid.text}');
  ...
  void deleteData(id) async{
    final url = Uri.parse('http://68.178.163.174:5010/vermi_compost/earthworm_labour/delete?id=${id}');
