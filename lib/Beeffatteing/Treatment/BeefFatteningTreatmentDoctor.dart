...
class _BeefFatteningTreatmentDoctorState extends State<BeefFatteningTreatmentDoctor> {
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/doctors/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/doctors/edit?id=${editid.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/doctors/delete?id=${id}');
