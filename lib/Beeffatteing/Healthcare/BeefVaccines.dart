...
class _BeefVaccinesState extends State<BeefVaccines> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/vaccines');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/vaccines/add');
  ...
  void editData() async{
    final url = Uri.parse('http://68.178.163.174:5010/cattles/vaccines/edit?id=${editId.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/vaccines/delete?id=${id}');
