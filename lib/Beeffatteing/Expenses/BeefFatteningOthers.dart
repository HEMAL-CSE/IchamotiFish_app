...
class _BeefFatteningOthersState extends State<BeefFatteningOthers> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/beef_others');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/beef_others/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/beef_others/edit?id=${editid.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/cattles/beef_others/delete?id=${id}');
