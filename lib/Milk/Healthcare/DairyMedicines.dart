...
class _DairyMedicinesState extends State<DairyMedicines> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/medicines');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/medicines/add');
  ...
  void editData() async{
    final url = Uri.parse('http://68.178.163.174:5010/dairy/medicines/edit?id=${editId.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/medicines/delete?id=${id}');
