...
class _DairyLabourState extends State<DairyLabour> {
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/expenses/labour/add');
  ...
  void editData() async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/expenses/labour/edit?id=${editid.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/expenses/labour/delete?id=${id}');
