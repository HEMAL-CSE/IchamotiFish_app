...
class _DairyFeedingState extends State<DairyFeeding> {
  ...
  void getData() async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/feed_names');
  ...
  void addData() async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/feed_names/add');
  ...
  void editData() async{
    final url = Uri.parse('http://68.178.163.174:5010/dairy/feed_names/edit?id=${editId.text}');
  ...
  void deleteData(id) async {
    final url = Uri.parse('http://68.178.163.174:5010/dairy/feed_names/delete?id=${id}');
